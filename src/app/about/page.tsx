    ...
    <>
      ...
      <section className="relative overflow-hidden border-t border-border py-16">
        ...
        <div className="relative mx-auto max-w-3xl px-6">
          ...
          <p className="mt-2 text-sm text-muted">Things I&apos;ve actually used and built with.</p>
          <div className="mt-6 grid gap-4 rounded-md border border-border bg-background/70 p-5 backdrop-blur-sm sm:grid-cols-2">
            <div>
              <p className="font-mono text-[11px] uppercase tracking-widest text-muted">
                Languages
              </p>
      ...
      <section id="contact" className="scroll-mt-20 border-t border-border bg-accent text-black">
        <div className="mx-auto max-w-3xl px-6 py-20">
          ...
          <div className="mt-8 flex flex-wrap gap-x-8 gap-y-2 border-t border-black/20 pt-6 font-mono text-xs uppercase tracking-widest">
            ...
            <a href={site.resumeUrl} className="hover:underline">
              Résumé
            </a>
          </div>
        </div>
